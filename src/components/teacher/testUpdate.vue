<template>
    <div>
        <el-form ref="form" :model="form" label-width="80px" :rules="rules">
            <el-form-item label="ID">{{form.tid}}</el-form-item>
...
//                    ],
        ...
        methods: {
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$http.post('/home/testUpdate.php',this.form).then(res=>{
                            if(res.body=='ok'){
                                this.$message({
                                    message:'恭喜你，修改成功',
                                    type:"success"
        ...
        mounted(){
            ...
            this.$http.get('/home/testQuery.php?tid='+this.tid).then(res=>{
                this.form=res.body
            })
